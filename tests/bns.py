#!/usr/bin/env python
"""
https://git.ligo.org/lscsoft/bilby/-/blob/master/examples/gw_examples/injection_examples/binary_neutron_star_example.py
...
result = bilby.run_sampler(
    ...
    priors=priors, sampler='dynesty', npoints=1000, walks=100,  nact=10,
    sample="rwalk",
